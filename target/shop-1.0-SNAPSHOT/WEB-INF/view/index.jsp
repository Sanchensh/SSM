...
<head>
    ...
    <script src="<%=request.getContextPath()%>/bootstrap/js/bootstrap-paginator.min.js"></script>
    <style type="text/css">
        #queryDiv {
            margin-right: auto;
            margin-left: auto;
...
<body>
    ...
    <p> ${requestScope.buyer.buyerName}，您好</p>
                        ...
                        if(data.isError == false) {
                            ...
                            if (dataList.length > 0 ) {
                                $(dataList).each(function(){//重新生成
                                    $("#tableBody").append('<tr>');
                                    $("#tableBody").append('<td>' + this.bookId + '</td>');
                                    $("#tableBody").append('<td>' + this.bookName + '</td>');
                                    $("#tableBody").append('<td>' + this.publisher + '</td>');
                                    $("#tableBody").append('<td>' + this.bookCount + '</td>');
                                    $("#tableBody").append('</tr>');
                                });
                            } else {
